(function () {
    ...
    frappe.ui.form.ControlDate = frappe.ui.form.ControlData.extend({
    	...
    	set_date_options: function() {
    		...
    		var lang = frappe.boot.user.language || 'en';
    		...
    		this.$input.on("input", frappe.utils.debounce(function(e) {
    			...
    			frappe.call({
    				...
    				callback: function(r) {
    					...
    					if (args.filters) {
    						var filter_string = [];
    						for (var i = 0, list = Object.entries(args.filters); i < list.length; i += 1) {
    ...
    // ignored /opt/bench/erpnext/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
    ...
    frappe.ui.form.ControlMultiSelectList = frappe.ui.form.ControlData.extend({
    	make_input: function make_input() {
    		...
    		this.$list_wrapper.on('input', 'input', function (e) {
    			...
    			this$1.set_selectable_items(filtered_options);
    		});
    	...
    	make() {
    		...
    		this.comment_area = frappe.ui.form.make_control({
    			...
    			on_submit: function (val) {
    				val && this$1.insert_comment(val, this$1.comment_area.button);
    			}
    		});
